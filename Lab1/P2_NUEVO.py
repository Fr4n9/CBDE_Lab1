...
millor_similitud_cos = -2 # posem -2 o qualsevol valor negatiu ja que la similitud per cosinus va de [-1,1]
...
millor_similitud_euclidean_1 = np.inf; #ara busquem la distancia menor, al contrari del cosinus que busquem el major numero
...
print(f"Temps: {elapsed:.2f} segons")
print("Els ids de la major similitud son", millors_id_1,millors_id_2,"amb una similitud de",millor_similitud)
